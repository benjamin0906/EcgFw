...
#define FILTER_1_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_1_ASSIGNED_DMA_STREAM     Stream1
#define FILTER_2_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_2_ASSIGNED_DMA_STREAM     Stream2
#define FILTER_3_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_3_ASSIGNED_DMA_STREAM     Stream4
#define FILTER_4_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_4_ASSIGNED_DMA_STREAM     Stream5
#define FILTER_5_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_5_ASSIGNED_DMA_STREAM     Stream6
#define FILTER_6_ASSIGNED_DMA_INSTANCE   DMA2
#define FILTER_6_ASSIGNED_DMA_STREAM     Stream7
